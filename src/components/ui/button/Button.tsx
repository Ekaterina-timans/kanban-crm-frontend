...
type TypeButton = ButtonHTMLAttributes<HTMLButtonElement> & VariantProps<typeof buttonVariants> & {
	Icon?: LucideIcon
	...
	return (
		<button
			className={cn(buttonVariants(
				...
				// 'linear rounded-lg bg-zinc-500 shadow py-2 px-7 text-base font-medium transition hover:bg-gray-400 active:bg-brand-700',
			)}
			{...rest}
		>
			{Icon && (
